...
require_once __DIR__ . "/../includes/db.php"; // Adjust the path as necessary
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-header">
                ...
                <img src="<?= htmlspecialchars($currentUserInfo['profile_pic'] ?: '../assets/img/thank-you.png') ?>" alt="User Avatar" class="img-fluid rounded-circle mb-2">
